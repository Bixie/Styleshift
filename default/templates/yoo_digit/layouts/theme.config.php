...
/*
 * Add block width classes
 */

$widths = array_keys($config->get('block', array()));
$width_classes = array();
foreach ($widths as $width) {

    $width_classes[$width] = $config->get("block.{$width}.block-width") ? ' tm-block-full' : '';
...
$body_classes .= $config->get('fixed_navigation') ? ' tm-navbar-fixed' : '';
