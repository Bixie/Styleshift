...
<header>
	...
	<div class="metaHolder"><div class="titelSpecs">Specificaties:</div><ul class="meta"><?php echo $this->renderPosition('meta', array('style' => 'list')); ?></ul></div>
	<?php endif; ?>
...
<p class="pos-subtitle"><div class="subtitleHolder"><?php echo $this->renderPosition('subtitle', array('style' => 'block')); ?></div></p>
<?php endif; ?>
